from . import color_histogram_feature_extraction
...
def color_recognition(crop_img):
  ...
  open(current_path+"/vehicle_counting_tensorflow/utils/color_recognition_module/"+"test.data", "w")
  color_histogram_feature_extraction.color_histogram_of_test_image(crop_img) # send image piece to regonize vehicle color
  prediction = knn_classifier.main(current_path + "/vehicle_counting_tensorflow/utils/color_recognition_module/" + "training.data", current_path + "/vehicle_counting_tensorflow/utils/color_recognition_module/" + "test.data")
